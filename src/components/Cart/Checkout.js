...
const Checkout = props => {
    ...
    const streetControlStyles = `${styles.control} ${formInputValidity.street ? '' : styles.invalid}`;
    const postalCodeControlStyles = `${styles.control} ${formInputValidity.postalCode ? '' : styles.invalid}`;
